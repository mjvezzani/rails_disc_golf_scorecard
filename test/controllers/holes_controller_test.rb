...
class HolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hole" do
    assert_difference('Hole.count') do
      post holes_url, params: { hole: { course_id: @hole.course_id, number: @hole.number, par: @hole.par } }
    end
  ...
  test "should update hole" do
    patch hole_url(@hole), params: { hole: { course_id: @hole.course_id, number: @hole.number, par: @hole.par } }
